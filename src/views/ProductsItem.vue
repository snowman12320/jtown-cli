  ...
  <div class="container-xxl">
    ...
    <div class="row row-cols-md-2 g-5 mt-5">
      <div id="carouselExampleIndicators" class="carousel slide col-md-6" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://source.unsplash.com/random/1500x1200/?basketball" class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img src="https://source.unsplash.com/random/1500x1200/?coat" class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img src="https://source.unsplash.com/random/1500x1200/?coat" class="d-block w-100" alt="..." />
          </div>
      ...
      <div class="col-md-6 d-flex flex-column justify-content-around text-center">
        <h1 class="mb-5">球衣名</h1>
        <h2 class="text-center">$15,555</h2>
        <div class="justify-content-center d-flex align-items-center my-3 gap-5">
          <div class="fs-1 d-flex justify-content-center gap-3 align-items-center">
            <button style="height:40px" class="btn btn-outline-secondary py-0">-</button>
            <span class="">{{ count }}</span>
            <button style="height:40px" @click="count++" class="btn btn-outline-secondary py-0">+</button>
          </div>
          <!--  -->
